...
static const struct pinctrl_pin_desc sm7250_pins[] = {
...
static const struct msm_function sm7250_functions[] = {
	FUNCTION(qup01),
	FUNCTION(gpio),
 ...
 */
static const struct msm_pingroup sm7250_groups[] = {
...
static const struct msm_pinctrl_soc_data sm7250_pinctrl = {
	.pins = sm7250_pins,
...
static int sm7250_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &sm7250_pinctrl);
}

static const struct of_device_id sm7250_pinctrl_of_match[] = {
	{ .compatible = "qcom,sm7250-pinctrl", },
	{ },
};

static struct platform_driver sm7250_pinctrl_driver = {
	.driver = {
		.name = "sm7250-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = sm7250_pinctrl_of_match,
	},
	.probe = sm7250_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init sm7250_pinctrl_init(void)
{
	return platform_driver_register(&sm7250_pinctrl_driver);
}
arch_initcall(sm7250_pinctrl_init);

static void __exit sm7250_pinctrl_exit(void)
{
	platform_driver_unregister(&sm7250_pinctrl_driver);
}
module_exit(sm7250_pinctrl_exit);

MODULE_DESCRIPTION("QTI sm7250 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, sm7250_pinctrl_of_match);
